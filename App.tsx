        ...
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] font-black text-red-600 tracking-widest mt-1 uppercase">Ultimate Permission Fix v6.5</p>
            </div>
          </div>
          <div className="flex items-center gap-2 px-3 py-1 bg-black rounded-full border border-gray-800">
             <div className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse"></div>
             <span className="text-[9px] font-black text-white uppercase tracking-widest">Auth Required Exception</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 mt-12">
        <div className="bg-white p-10 rounded-[3rem] shadow-sm border border-gray-100">
          <div className="max-w-2xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-black text-gray-900 mb-4 leading-tight">Fixing <br/><span className="text-red-600">UrlFetchApp Permission</span></h2>
            <p className="text-gray-500 text-sm leading-relaxed">
              If you see "Required Permissions", it means you've added the code but haven't given Google <b>explicit permission</b> to use it yet. 
              Follow the 3-step checklist below to force the authorization dialog.
            </p>
          </div>

          <AppsScriptCode />

          <div className="mt-16 bg-red-50 p-8 rounded-[2rem] border border-red-100">
             <h3 className="text-sm font-black text-red-900 mb-6 uppercase tracking-widest">Why do I keep getting this error?</h3>
             <p className="text-[11px] text-red-700 leading-relaxed font-medium">
               Google Apps Script Add-ons are very strict. Even if your <code>appsscript.json</code> is perfect, Google will not show you the "Grant Access" screen automatically for external requests. 
               You <b>must</b> manually run a function in the editor to trigger the one-time security popup.
             </p>
          </div>
        </div>
      </main>
